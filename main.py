...
convo = model.start_chat(history=[
    ...
    },
    {
        ...
        "user",
        "parts": [
            "caso o código pedido não for shell script mande o comando para adicionar ele dentro do arquivo correspondente"
        ]
    },
    {
        "role": "model",
    ...
    },
    {
        ...
        "user",
        "parts": [
            "quando pedir pra colocar algo dentro de um arquivo crie um comando shell para isso"
        ]
    },
    {
        "role": "model",
